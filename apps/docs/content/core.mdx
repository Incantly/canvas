...
description: Use the framework-free Incantly Canvas core in any web page — zero dependencies, no build step required.
---
...
Don't forget the stylesheet: `@incantly/canvas/canvas.css` (import it
...
Pass the same `Store` to two `createCanvas` calls and both render the
