...
description: Hide Incantly Canvas's toolbar and drive the editor from your own interface — every tool and style is reachable from the public API.
---
...
```jsx
<Canvas ref={ref} hideUi />
```

```js
// plain JS
const board = createCanvas({ container, hideUi: true })
```
